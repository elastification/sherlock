...
class OrFilter extends \Sherlock\components\BaseComponent implements \Sherlock\components\FilterInterface
{
    ...
    /**
     * @param  \Sherlock\components\QueryInterface | \Sherlock\components\QueryInterface | array $values,... - one or
     *                                               more Queries can be specified individually, or an array of filters
     *
     * @return OrFilter
     */
