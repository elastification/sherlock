 ...
 *
 * @method \Sherlock\components\queries\MultiMatch boost() boost(\float $value) Optional boosting for term value.
 *         Default = 1
 * @method \Sherlock\components\queries\MultiMatch operator() operator(\string $operator) Optional operator for match
 *         query. Default = 'and'
 * @method \Sherlock\components\queries\MultiMatch analyzer() analyzer(\string $analyzer) Optional analyzer for match
 *         query. Default to 'default'
 * @method \Sherlock\components\queries\MultiMatch fuzziness() fuzziness(\float $value) Optional amount of fuzziness.
 *         Default to null
 * @method \Sherlock\components\queries\MultiMatch fuzzy_rewrite() fuzzy_rewrite(\string $value) Default to
 ...
 * @method \Sherlock\components\queries\MultiMatch minimum_should_match() minimum_should_match(\int $value) Default to
 *         2
