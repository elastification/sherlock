 ...
 * @method \Sherlock\components\queries\QueryStringMultiField enable_position_increments()
 *         enable_position_increments(\bool $value) Default: true
 * @method \Sherlock\components\queries\QueryStringMultiField default_operator() default_operator(\string $value)
 *         Default: "OR"
 * @method \Sherlock\components\queries\QueryStringMultiField analyzer() analyzer(\string $value) Default: "default"
 * @method \Sherlock\components\queries\QueryStringMultiField allow_leading_wildcard() allow_leading_wildcard(\bool
 *         $value) Default: false
 * @method \Sherlock\components\queries\QueryStringMultiField lowercase_expanded_terms() lowercase_expanded_terms(\int
 *         $value) Default: 1
 * @method \Sherlock\components\queries\QueryStringMultiField fuzzy_min_sim() fuzzy_min_sim(\float $value) Default: 0.5
 * @method \Sherlock\components\queries\QueryStringMultiField fuzzy_prefix_length() fuzzy_prefix_length(\int $value)
 *         Default: 2
 ...
 * @method \Sherlock\components\queries\QueryStringMultiField analyze_wildcard() analyze_wildcard(\bool $value)
 *         Default: true
 * @method \Sherlock\components\queries\QueryStringMultiField auto_generate_phrase_queries()
 *         auto_generate_phrase_queries(\int $value) Default: 0
 * @method \Sherlock\components\queries\QueryStringMultiField rewrite() rewrite(\string $value) Default:
 *         "constant_score_default"
 * @method \Sherlock\components\queries\QueryStringMultiField quote_analyzer() quote_analyzer(\string $value) Default:
 *         "standard"
 * @method \Sherlock\components\queries\QueryStringMultiField quote_field_suffix() quote_field_suffix(\string $value)
 *         Default: ".unstemmed"
